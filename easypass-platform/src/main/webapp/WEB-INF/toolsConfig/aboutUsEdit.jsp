						...
						<form class="form-horizontal" role="form" novalidate enctype="multipart/form-data" method="post" id="updateAboutUsForm" >
								...
								<div class="form-group item">
									...
									<div class="col-lg-6">
										...
										<input type="text" class="form-control optional required" id="telephone" name="telephone" value="${appAboutUs.telephone}"  placeholder="请输入电话" data-validate-length-range="0,20">
									</div>
								...
								<div class="form-group item">
									...
									<div class="col-lg-6">
										<textarea rows="10" cols="100" placeholder="请输入description" name="description" id="description" style="width:500px;">${appAboutUs.description}</textarea>
									</div>
									<div class="col-lg-4">
									</div>
...
<!-- 							</div> -->
	...
	$(function(){
		$("#logoFile").click(function(){
			new uploadPreview({ UpBtn: "logoFile", DivShow: "logoImgDiv", ImgShow: "logoImgs" });
		});
	...
	function save() {
		var url=ctx+"admin/toolsConfig/updateAboutUs?time="+(new Date()).getTime();
		swal({"title":"","text":"正在处理……请稍后","showConfirmButton":false});
		$.ajax({
			url: url,
			dataType: "json",
			data:$("#updateAboutUsForm").serialize(),
