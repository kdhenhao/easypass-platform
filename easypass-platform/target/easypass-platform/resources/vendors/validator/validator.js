...
var validator = (function($){
            ...
            if( pattern ){
                ...
                switch( pattern ){
                    ...
                    case 'numeric' :
                        ...
                        break;
                    case 'phone' :
                        regex = /^(13|15|18|17)\d{9}$/i;
                        break;
                    case 'tel' :
                    	regex = /^((\(\d{2,3}\))|(\d{3}\-))?(\(0\d{2,3}\)|0\d{2,3}-)?[1-9]\d{6,7}(\-\d{1,4})?$/i;
                    	break;
                    case 'date' :
    ...
    */
    ...
    function testByType(type, value){
        ...
        return tests[type] ? tests[type](value, false) : true;
    }
    ...
    */
    function checkField(){
        ...
        field.data( 'val', $.trim(field[0].value));
        data = field.data();
