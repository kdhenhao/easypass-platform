						...
						<form class="form-horizontal" role="form" novalidate enctype="multipart/form-data" method="post" id="addCourseForm" >
							...
							<div class="container" id="courseInfo">
								...
								<div class="form-group item">
									...
									<div class="col-lg-6">
										<input type="number" class="form-control number required"  placeholder="请输入课程积分" name="points" id="points"  value="${course.points}" data-validate-length-range="0,5"
										>
									</div>
									<div class="col-lg-4">
										<label class="control-label" style="color: #ccc;">*必填项</label>
								...
								<div class="form-group item">
									<div class="col-lg-2" style="text-align: right;">
									<label class="control-label">平均成绩：</label>
									</div>
									<div class="col-lg-6">
										<input type="number" class="form-control number required"  placeholder="请输入平均成绩" name="averageMarks" id="averageMarks"  value="${course.averageMarks}" data-validate-length-range="0,5" >
									</div>
									<div class="col-lg-4">
										<label class="control-label" style="color: #ccc;">*必填项</label>
									</div>
